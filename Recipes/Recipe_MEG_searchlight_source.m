...
parfor subject_i = 1:nSubjects
    ...
    for chi = 'LR'
        ...
        [maskedMeshesThisSubjectThisHemi, STCMetadatas{subject_i}] = rsa.meg.MEGDataPreparation_source( ...
            betaCorrespondence(), ...
            userOptions, ...
            'mask', slMasks([slMasks.chi] == chi), ...
            'subject_i', subject_i, ...
            'chi', chi);
        ...
        [RDMPaths(subject_i).(chi)] = rsa.meg.MEGSearchlightRDMs_source( ...
            subject_i, ...
            chi, ...
            maskedMeshesThisSubjectThisHemi.(userOptions.subjectNames{subject_i}).(chi), ...
