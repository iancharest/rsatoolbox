...
%
%  Cai Wingfield 11-2009, Li Su updated 2-2012
...
userOptions.analysisName = 'glm_lexpro';

% This is the root directory of the project.
userOptions.rootPath = '/imaging/iz01/NeuroLex/glm/';
...
userOptions.betaPath = '/imaging/iz01/lexpro_data/vert_10242/[[betaIdentifier]]';

%% This sets the preference for Matlab parallel computing toolbox
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = '/imaging/ef02/lexpro/subject/average/label/[[maskName]]';
		...
		% time windows are specified for each regions. For ROI analysis,
		% different time windows can be set for different ROIs, but it can
		% also be used for searchlight analysis to reduce the search space,
		% in searchlight analysis, time window should be same for all ROIs.
...
%% SEARCHLIGHT OPTIONS %%
%%%%%%%%%%%%%%%%%%%%%%%%%
        userOptions.searchlight = true; % if mask set to true, will use 
                                        % temporalsearchlightLimits rather
                                        % than maskTimeWindows
	%% %% %% %% %%
	...
	%% %% %% %% %%
		...
		% OR (source space)
			...
			userOptions.sourceSearchlightRadius = 30;

			% The average surface files
			userOptions.averageSurfaceFile = '/imaging/ef02/lexpro/subject/average/surf/lh.inflated';

		% The width of the sliding window (ms)
		userOptions.temporalSearchlightWidth = 30;
		...
		userOptions.temporalSearchlightResolution = 10; % (data point equivalent = total_in_ms/total_dataPoints)

		% The overall window of interest (ms)
		userOptions.temporalSearchlightLimits = [-50 210]; 
...
%        '0319', ...
        ...
        'meg08_0327', ...
		'meg08_0348', ...		
		'meg08_0350', ... %	'meg08_0363', ...
        'meg08_0366', ...
        'meg08_0371', ...
        'meg08_0372', ...    
		'meg08_0377', ...      % 'meg08_0380', ...	
		'meg08_0397', ...
		'meg08_0400', ...		
		'meg08_0401', ...
		'meg08_0402' ...
...
'played','trade','trend','claim','cream' ...
	};
...
userOptions.conditionColours = rand(5,3);
...
userOptions.significanceTestPermutations = 100;
